...
var app = new Vue({
    ...
    methods: {      
        ...
        showModalSearch : function(){
            this.modalShownSearch=true
        ...
        addRecipe(){
            this.recipes.push({
                ...
                description: this.currentRecipeDescription,
                directions: this.currentRecipeDirections
            })
        ...
        deleteRecipe:function(){
           if(this.searchedIngredient){
            alert('Please finish your search first')
            return
        }
...
loadRecipes: function(){
    if (localStorage.getItem('recipes')) {
        ...
        this.currentId=this.recipes.length
    }else{
        this.storeRecipes()
    }
},
...
searchRecipes:function(){
  ...
  for(i=0;i<this.recipes.length;i++){
   if(this.recipes[i].description.includes(this.searchedIngredient)){
...
watch: {
    searchedIngredient: function (val) {
       if(!val){
           this.loadRecipes()
           this.changeRecipesOnClick(0)
