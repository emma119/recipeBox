...
var app = new Vue({
    ...
    methods: {
        saveRecipe(){
            this.recipes.push({
                id: this.currentId++,
                title: this.currentRecipe
            })
            this.currentRecipe = ''
        },

        recipesDescription(title, description, directions ){

            this.clickedTitleDescription=title,
            this.clickedRecipeDescription = description,
          this.clickedDirectionsDescription=directions
